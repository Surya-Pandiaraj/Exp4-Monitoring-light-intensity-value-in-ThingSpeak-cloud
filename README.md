...
# MONITORING LIGHT INTENSITY VALUE IN THINGSPPEAK CLOUD
...
char ssid[] = "Surya's iphone"; 
char pass[] = "12345678";
int keyIndex = 0;
WiFiClient  client;

unsigned long myChannelNumber = 2755063;
const int ChannelField = 1;
const char * myWriteAPIKey = "N62T3TB8M7T83WWB";
...
# OUTPUT
 ...
 ![image](https://github.com/user-attachments/assets/0fa03096-e63c-4bde-b92c-a96d2693c967)

 ![image](https://github.com/user-attachments/assets/50377faa-2e36-42cd-8464-bb35c4149aca)
